                ...
                filtered.map((m) => {
                  ...
                  return (
                    <button
                      ...
                      className="block w-full border-b border-[var(--color-border)] px-5 py-4 text-left last:border-b-0 hover:bg-[var(--color-surface-raised)]"
                      style={isActive ? { background: "var(--color-surface-raised)", borderLeft: "3px solid var(--color-vault)" } : undefined}
                    >
